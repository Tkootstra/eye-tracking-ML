...
results = load('RF_Bayesian_results.pkl')
best_params = results.x



    
model = RandomForestClassifier(n_estimators=800, min_samples_leaf=best_params[0], max_features=best_params[1],
                                    min_samples_split=best_params[2], max_depth=best_params[3], 
                                    criterion=best_params[4], n_jobs=-1)
